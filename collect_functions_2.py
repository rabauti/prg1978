...
def extract_something(graph, collection_id, collocations, verb_global_stat):
    ...
    # key = ( 'verb', 'verb_deprel',
    # 'verb_compound', 'deprel1', 'case1', 'verbform1',
    ...
    for verb in verb_nodes:
        ...
        if not len(kids) or not len(kids_with_required_data):
            ...
            # key = ( 'verb',  'verb_compound', 'deprel1', 'case1', 'verbform1',
            # 'obl_case1', 'deprel2', 'case2', 'verbform2', 'obl_case2')
            key = (
                v_lemma,
                verb_compound,
        ...
        for k1 in kids_with_required_data:
            ...
            for k2 in kids_with_required_data:
                ...
                # 'verbform1', 'obl_case1', 'deprel2', 'case2',
                # 'verbform2', 'obl_case2')
