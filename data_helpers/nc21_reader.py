...
9 punctuation_type - marks punctuation types, e.g. Quo ("), Col (:), Scl(;). It covers only 24 most commonly used punctuation symbols, so it's not an extensive feature (link)
